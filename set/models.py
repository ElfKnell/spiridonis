...
class Set(models.Model):
    ...
    main_product = models.OneToOneField(Product, on_delete=models.CASCADE, related_name='main')
    product_1 = models.OneToOneField(Product, on_delete=models.CASCADE, related_name='first')
    product_2 = models.OneToOneField(Product, on_delete=models.CASCADE, related_name='second', blank=True, null=True)
    product_3 = models.OneToOneField(Product, on_delete=models.CASCADE, related_name='third', blank=True, null=True)
